# Whiteboard with Delete and Undo

A basic web-paint application built using HTML, CSS, and JavaScript. This app allows users to draw on a canvas, delete the drawing, and undo the last drawing.
...
<head>
    ...
    <title>Whiteboard with Delete & Undo</title>
